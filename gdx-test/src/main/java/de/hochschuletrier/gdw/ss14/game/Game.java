...
import de.hochschuletrier.gdw.ss14.game.systems.ClientSystem;
...
public class Game extends InputAdapter {
    ...
    private final ClientSystem networkSystem = new ClientSystem(this, GameConstants.PRIORITY_NETWORK);
